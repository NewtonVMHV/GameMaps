...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabelLoginForm.setText("INICIAR SESION");
        ...
        jLabelLoginForm1.setText("Autenticacion de usuario ");
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        ...
        if (uname.equals("test") && psswd.equals("test")) {
            ...
            this.dispose();
        }else if (uname.equals("ronzon") && psswd.equals("test")){
            new DashboardFormHome().setVisible(true);
            this.dispose();
        }else if (uname.equals("alfonso") && psswd.equals("test")){
            new DashboardFormHome().setVisible(true);
            this.dispose();
        }else if (uname.equals("dorys") && psswd.equals("test")){
            new DashboardFormHome().setVisible(true);
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(LoginForm.this, "usuario/contraseña son incorrecta");
        }
        // TODO add your handling code here:
