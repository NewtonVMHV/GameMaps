...
public class Mapa extends JPanel implements MouseListener,MouseMotionListener
{
    ...
    public Mapa (){
        ...
        habitantes.setForeground(Color.white);
        habitantes.setFont(fuente);
         String sonido = "C:\\Users\\victor\\Documents\\NetBeansProjects\\Republica\\src\\republica\\mapa.wav";
       try{
 ...
 g.drawPolygon(Quintanaroo);
    ...
    public void mouseClicked(MouseEvent e){
        ...
        if(AguasCalientes.contains(p)) {
            info.setText("Estado: Aguascalientes");
            habitantes.setText("Habitantes: 1 252 265");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("aguascalientes.jpg"));
            img = aux.getImage();
           ...
           habitantes.setText("Habitantes: 3 381 080");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("baja-california.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Baja California Sur");
             habitantes.setText("Habitantes: 718 196");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("baja-california-sur.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Campeche");
             habitantes.setText("Habitantes: 880 299");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("campeche.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Coahuila");
             habitantes.setText("Habitantes: 2 890 108");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("coahuila.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Colima");
             habitantes.setText("Habitantes: 698 295");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("colima.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Chiapas");
             habitantes.setText("Habitantes: 5 119 186");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("chiapas.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Chihuahua");
             habitantes.setText("Habitantes: 3 635 966");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("chihuahua.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Distrito Federal");
             habitantes.setText("Habitantes:8 893 742");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("ciudad-de-mexico.jpgg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Durango");
             habitantes.setText("Habitantes: 1 728 429");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("durango.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Guanajuato");
             habitantes.setText("Habitantes: 5 719 709");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("guanajuato.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Guerrero");
             habitantes.setText("Habitantes: 3 523 858");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("guerrero.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Hidalgo");
             habitantes.setText("Habitantes: 2 806 334");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("hidalgo.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Jalisco");
             habitantes.setText("Habitantes: 7 742 303");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("jalisco.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Estado De Mexico");
             habitantes.setText("Habitantes: 16 364 210");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("mexico.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Michoacan");
             habitantes.setText("Habitantes: 4 529 914");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("michoacan.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Morelos");
             habitantes.setText("Habitantes:1 874 188");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("morelos.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado:  Nayarit");
             habitantes.setText("Habitantes: 1 178 403");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("nayarit.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Nuevo Leon");
             habitantes.setText("Habitantes: 4 941 059");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("nuevo-leon.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Oaxaca");
             habitantes.setText("Habitantes: 3 959 042");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("oaxaca.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Puebla");
             habitantes.setText("Habitantes: 6 067 607");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("puebla.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Queretaro");
             habitantes.setText("Habitantes: 1 943 889");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("queretaro.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Quintana Roo");
             habitantes.setText("Habitantes: 1 484 960");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("quintana-roo.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: San Luis Potosi");
             habitantes.setText("Habitantes: 2 702 145");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("san-luis-potosi.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Sinaloa");
             habitantes.setText("Habitantes: 2 932 313");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("sinaloa.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Sonora");
             habitantes.setText("Habitantes: 2 851 462");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("sonora.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Tabasco");
             habitantes.setText("Habitantes: 2 334 493");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("tabasco.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Tamaulipas");
             habitantes.setText("Habitantes: 3 461 336");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("tamaulipas.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Tlaxcala");
             habitantes.setText("Habitantes: 1 242 734");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("tlaxcala.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Veracruz");
             habitantes.setText("Habitantes: 7 923 198");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("veracruz.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Yucatan");
             habitantes.setText("Habitantes: 2 064 151");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("yucatan.jpg"));
            img = aux.getImage();
            ...
            info.setText("Estado: Zacatecas");
             habitantes.setText("Habitantes: 1 550 179");
            try {
            ImageIcon aux = new ImageIcon(this.getClass().getResource("zacatecas.jpg"));
            img = aux.getImage();
